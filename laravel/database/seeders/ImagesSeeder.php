...
class ImagesSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('images')->insert([
            [
                'image_path' => 'laravel\public\images\iphone_12-removebg-preview.png',
                'alt_text' => 'mobil',
                'product_id' => 4, 
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'image_path' => 'laravel\public\images\iphone 14.png',
                'alt_text' => 'mobil',
                'product_id' => 2,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'image_path' => 'laravel\public\images\15_pro_max-removebg-preview.png',
                'alt_text' => 'mobil',
                'product_id' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'image_path' => 'laravel\public\images\13-removebg-preview.png',
                'alt_text' => 'mobil',
                'product_id' => 3,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'image_path' => 'laravel\public\images\iphone 11.png',
                'alt_text' => 'mobil',
                'product_id' => 5,
                'created_at' => now(),
                'updated_at' => now(),
